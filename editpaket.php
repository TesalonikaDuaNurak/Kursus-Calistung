...
<body>
  ...
  <div class="sidebar">
   ...
   <section class="home-section">
	...
	<div class="home-content">
  <?php  $data = mysqli_query($koneksi,"select * from tb_paket WHERE id_paket='$_GET[id]'");
		$d = mysqli_fetch_array($data);?>
    <form method="post" action="editpaket1.php?id=<?= $d['id_paket'];?>">
    <div class="form-group">
    <label for="exampleInputEmail1">Nama Paket</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $d['nama_paket'];?>" name="nama">
    <input type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $d['id_paket'];?>" name="id">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Harga Paket</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $d['harga_paket'];?>" name="harga">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Keterangan Paket</label>
   <textarea name="ket" id=""><?php echo $d['ket'];?></textarea>
  </div>
