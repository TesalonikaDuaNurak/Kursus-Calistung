...
<body>
  ...
  <div class="sidebar">
   ...
   <section class="home-section">
	...
	<div class="home-content">
  <?php  $data = mysqli_query($koneksi,"select * from tb_admin WHERE id='$_GET[id]'");
		$d = mysqli_fetch_array($data);?>
    <form method="post" action="editadmin.php?id=<?= $d['id'];?>">
    <div class="form-group">
    <label for="exampleInputEmail1">Email address</label>
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $d['email'];?>" name="email">
    <input type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $d['id'];?>" name="id">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Username</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $d['username'];?>" name="username">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Password</label>
    <input type="password" class="form-control" id="exampleInputPassword1" value="<?= $d['password'];?>" name="password">
  </div>
