...
<body>
  ...
  <div class="sidebar">
   ...
   <section class="home-section">
	...
	<div class="home-content">
    <a href="inputpaket.php" class="btn btn-sm btn-success">INPUT</a>
  ...
  <?php 
    ...
    <td><?php echo $no++; ?></td>
				...
				<td>
					<a href="editpaket.php?id=<?php echo $d['id_paket']; ?>" class="btn btn-sm btn-warning">EDIT</a>
					<a href="hapuspaket.php?id=<?php echo $d['id_paket']; ?>" class="btn btn-danger">HAPUS</a>
				</td>
</tr>
<?php } ?>
</tbody>
