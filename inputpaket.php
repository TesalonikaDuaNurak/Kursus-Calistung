...
<body>
  ...
  <div class="sidebar">
   ...
   <section class="home-section">
	...
	<div class="home-content">
    <form method="post" action="inputpaket1.php">
    
    <div class="form-group">
    <label for="exampleInputEmail1">Nama Paket</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Nama Paket" name="nama_paket">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Harga Paket</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Harga Paket" name="harga_paket">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Keterangan Paket</label>
    <textarea name="ket" id=""></textarea>
  </div>
